...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                // 3. Ürünler
                createProduct("iPhone 14", "En yeni iPhone modeli.", new BigDecimal("35000"), 50, "iphone-14",
                                elektronik,
                                "https://images.unsplash.com/photo-1678685888221-cda773a3dcdb?auto=format&fit=crop&w=500&q=80");
                createProduct("MacBook Pro M2", "Güçlü performans.", new BigDecimal("45000"), 30, "macbook-pro-m2",
                                elektronik,
                                "https://images.unsplash.com/photo-1517336714731-489689fd1ca4?auto=format&fit=crop&w=500&q=80");
                createProduct("Basic T-Shirt", "Pamuklu rahat tişört.", new BigDecimal("250"), 100, "basic-t-shirt",
                                giyim,
