...
public class OrderEventListener {
    ...
    public OrderEventListener(EmailService emailService, SpringTemplateEngine templateEngine) {
        this.emailService = emailService;
        this.templateEngine = templateEngine;
    }
    
    @EventListener
    public void handleOrderConfirmedEvent(OrderConfirmedEvent event) throws MessagingException{
        ...
        emailService.sendHtmlMail(
                event.getEmail(),
                "Sipariş Onayınız #" + event.getOrderNumber(),
                body
        );
